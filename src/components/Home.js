...
const Report=async()=>{
  const send=await axios.post('https://mynode-e6ly.onrender.com/reports',{reporterName,incidenceName,incidenceDetails,reporterNumber})
  try{
      ...
      <div className='' >
        {
          ...
          <div className=' text-black text-3xl font-light rounded-lg flex justify-end py-3 px-3' >
            <div className=' inline-block text-lg font-bold capitalize mr-5'>{name}</div>
          <div className=' inline-block ' onClick={handleToggle}><LiaTimesSolid  size={30} /></div> 
            </div>
          ...
          <div className=' flex justify-start items-start mt-8'>
            ...
            <div className=' inline-block capitalize font-semi-bold text-[15px] ml-3 font-sans  text-gray-500 cursor-pointer' onClick={handle}>About</div>
          </div>
          <div className=' flex justify-start items-start mt-8'>
            <div className=' px-3 inline-block font-semi-bold text-[15px] font-sans'><IoPerson size={18} /></div>
            <div className=' inline-block capitalize font-semi-bold text-[15px] ml-3 font-sans  text-gray-500 cursor-pointer' onClick={handle}>Profile</div>
          </div>
          <div className=' flex justify-center items-center mt-8'>
            <div className=' w-24 h-8 rounded-md drop-shadow-md bg-red-600 flex justify-center items-center font-bold text-white'>
            <div className=' inline-block capitalize font-semi-bold text-[17px] font-sans  mx-1 cursor-pointer' >logout</div>
            <div className=' inline-block font-semi-bold text-[15px] font-sans '><MdLogout size={18} /></div>
            </div>
          </div>
          <div className=' flex justify-center items-center mt-10'>
            <div className=' capitalize font-semi-bold text-[20px] ml-3 font-sans text-black cursor-pointer'>Actions</div>
          </div>
          <div className=' flex justify-start items-start mt-4'>
            <div className=' px-4 inline-block font-semi-bold text-[15px] font-sans'><FaPersonCircleExclamation size={18} /></div>
            <div className=' inline-block capitalize font-semi-bold text-[15px] ml-1 font-sans  text-gray-400 cursor-pointer'>Reports</div>
          </div>
          </div>
          <div onClick={handleToggle} className=' absolute w-full h-full z-10 bg-black opacity-50'> </div></div>
